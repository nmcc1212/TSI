...
console.log(
  "It would take",
  spaceship.getTime(1000000),
  "hours to travel 1,000,000 miles in a spaceship going at",
  spaceship.speed,
  "mph",
);
console.log(
  "It would take",
  car.getTime(1000000),
  "hours to travel 1,000,000 miles in a car going at",
  car.speed,
  "mph",
);
console.log(
  "It would take",
  bike.getTime(1000000),
  "hours to travel 1,000,000 miles in a bike going at",
  bike.speed,
  "mph",
);
