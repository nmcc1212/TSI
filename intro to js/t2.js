...
switch (company) {
  ...
  case "exxon Mobil":
    console.log(
      "Exxon Mobil is ranked 3rd, With a revenue of $413.680 billion.",
    );
    break;
  case "apple":
  ...
  case "unitedhealth group":
    console.log(
      "UnitedHealth Group is ranked 5th, With a revenue of $324.162 billion.",
    );
    break;
  case "cvs health":
    console.log(
      "CVS Health is ranked 6th, With a revenue of $322.467 billion.",
    );
    break;
  case "berkshire hathaway":
    console.log(
      "Berkshire Hathaway is ranked 7th, With a revenue of $302.089 billion.",
    );
    break;
  case "alphabet":
