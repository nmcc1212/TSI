...
describe("NavBar component", () => {
  it("renders the navbar", () => {
    const renderResult = render(<NavBar sendQueryToParent={() => {}} />);
    expect(renderResult.container.innerHTML).toContain(
      '<nav class="border-blue-200 bg-blue-200 dark:bg-blue-200 dark:border-blue-200"><div class="max-w-screen-xl flex flex-wrap items-center justify-center mx-auto p-4">',
    );
  });
