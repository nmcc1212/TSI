function click2img(game: string) {
    ...
    let gameid: HTMLImageElement = document.getElementById(game) as HTMLImageElement;
...
function unhideTable() {
    (document.getElementById("pcpp-table")as HTMLElement).style.display = "block";
}
function autohideTable() {
    if ((document.getElementById("pcpp-table")as HTMLElement).style.display == "none"){
        (document.getElementById("pcpp-table")as HTMLElement).style.display = "block";
    }
    else{
        (document.getElementById("pcpp-table")as HTMLElement).style.display = "none";
...
async function getAPOD() {
    ...
    let apod_explanation = document.getElementById("apod_explanation") as HTMLElement;
...
async function getAPODcal(){
    ...
    let date = dateElement.innerHTML = (document.getElementById("date")as HTMLInputElement).value;
    console.log(date);
    ...
    (document.getElementById("apod_explanation")as HTMLElement).innerHTML = data.explanation;
    console.log(data.url);
}
